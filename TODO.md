1. Store top 3 scores to localStorage
2. On game over display player score and time on end screen
3. check if player score is higher than any of the top 3
4. Allow player to key in 3-char initials if top 3
